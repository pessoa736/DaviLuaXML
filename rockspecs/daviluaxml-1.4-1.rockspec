...
description = {
   ...
   detailed = [[
      ...
      Changes in 1.4-1:
      - Added cache module for faster loading (avoids re-transformation)
      - Added compile module for pre-compilation (.dslx -> .lua)
      - Added dslxc CLI for compiling files and directories
   ]],
